...
function UpdateListing(props) {
    ...
    useEffect(()=>{        //it is a sync. behaviour so we can not use async inside useEffect
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='text-3xl font-semibold text-center my-7 text-custom_green-400'>Update a Listing</h1>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button className='p-3 bg-custom_green-400 text-white  rounded-lg hover:opacity-95 '>{Loading ? 'Creating...' : 'Update Listing'}</button>
